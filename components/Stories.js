            ...
            <div className="container font-inter grid justify-center text-center grid-cols-1 gap-y-10 md:text-left md:col-span-2 lg:px-20 after:content-[none] md:after:content-[''] md:after:top-3/4 md:after:left-4 lg:after:left-10 lg:after:top-[60%]">
                ...
                <div className="flex flex-wrap justify-center gap-y-5 gap-x-6 md:col-span-2 md:justify-start xl:grid xl:grid-cols-4">
                    <div className="text-left flex flex-col gap-y-3 max-w-[261px]">
                        <div className="h-[231px] bg-[url('/images/storyimg1.jpg')] bg-cover rounded-t-lg"></div>
                        ...
                        <Link href='#'><a className="text-orange hover:text-[#FF9E37] active:text-[#E97700] duration-200 font-semibold text-sm py-2">Read more</a></Link>
                    </div>

                    <div className="text-left flex flex-col gap-y-3 max-w-[261px]">
                        <div className="h-[231px] bg-[url('/images/storyimg2.jpg')] bg-cover rounded-t-lg"></div>
                    ...
                    <div className="text-left flex flex-col gap-y-3 max-w-[261px]">
                        <div className="h-[231px] bg-[url('/images/storyimg3.jpg')] bg-cover rounded-t-lg"></div>
                    ...
                    <div className="text-left flex flex-col gap-y-3 max-w-[261px]">
                        <div className="h-[231px] bg-[url('/images/storyimg4.jpg')] bg-cover rounded-t-lg"></div>
